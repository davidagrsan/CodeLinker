...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main class="perfilPublico">
        ...
        <div id="linksContainer" runat="server">
            <div>
                <asp:HyperLink ID="linkLinkedIn" runat="server"><i class="fa-brands fa-linkedin"></i></asp:HyperLink>
            </div>
            <div>
                <asp:HyperLink ID="linkGitHub" runat="server"><i class="fa-brands fa-github"></i></asp:HyperLink>
            </div>
        </div>
    </main>
</asp:Content>
